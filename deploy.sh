...
# core 모듈 복사
cp core/__init__.py \
  core/llm.py core/rule_matcher.py core/rule_enrichment.py core/weather.py \
  core/notifier.py core/safety_visuals.py core/risk_score.py \
  core/recipients.py core/alert_state.py core/media.py \
  "$SITE_PKG/core/"
