    ...
    <div className="fixed inset-0 bg-stone-900/50 backdrop-blur flex items-center justify-center z-50 p-4" onClick={onCancel}>
      <div className="bg-white rounded-lg p-6 max-w-md w-full shadow-[0_4px_12px_rgba(0,0,0,0.08)]" onClick={e => e.stopPropagation()}>
        <div className="flex items-center gap-3 mb-4">
          <div className="w-12 h-12 rounded-full bg-indigo-100 flex items-center justify-center text-indigo-600"><Lock size={22} strokeWidth={2} /></div>
          <div>
        ...
        <input 
          ...
          autoFocus
          placeholder="PIN 입력..."
          className="w-full px-3 py-2.5 border border-stone-300 rounded-lg text-sm focus:outline-none focus:border-indigo-500 font-mono"
        />
        ...
        <div className="flex gap-2 mt-4">
          ...
          <button onClick={handleSubmit} className="flex-1 px-4 py-2 rounded-lg bg-indigo-600 text-white text-sm font-semibold hover:bg-indigo-700 cursor-pointer">로그인</button>
        </div>
